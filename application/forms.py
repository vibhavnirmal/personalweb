...
class CompanyForm(FlaskForm):
    ...
    types = StringField(
        "Types", validators=[DataRequired()], render_kw={"placeholder": "Types"}
    )
...
class FoodForm(FlaskForm):
    name = StringField(
        "Food Name", validators=[DataRequired()], render_kw={"placeholder": "Food item name"}
    )

    description = TextAreaField(
        "Description",
        validators=[DataRequired()],
        render_kw={"placeholder": "Description / Ingredients / How did you like it?"},
    )

    price = FloatField(
        "Price", validators=[DataRequired()], render_kw={"placeholder": "Price"}
    )

    brand = StringField(
        "Brand", validators=[DataRequired()], render_kw={"placeholder": "Brand"}
    )
    category = StringField(
        "Category", validators=[DataRequired()], render_kw={"placeholder": "Category"}
    )
